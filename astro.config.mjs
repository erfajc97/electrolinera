  ...
  integrations: [
    ...
    sitemap({
      ...
      serialize(item) {
        ...
        if (item.url === 'https://disart.energy/') return { ...item, priority: 1.0 };
        if (
          item.url === 'https://disart.energy/solar/' ||
          item.url === 'https://disart.energy/movilidad/' ||
          item.url === 'https://disart.energy/electrolineras/'
